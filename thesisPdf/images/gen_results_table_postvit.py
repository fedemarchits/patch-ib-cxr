...
rows = [
    ...
    ('LocalAlign-3 (multi-scale FILIP probes)',[18.33, 18.43, 57.9,  0.1536, 0.4501, None,  None ], 1),
    ('MaskSTE-2 (STE + FILIP)',                [17.80, 17.70, 57.3,  0.1441, 0.4501, 0.334, 0.501], 2),
    ('MaskTopK-1 (Top-K, k=0.4)',              [18.33, 18.33, 58.5,  0.1184, 0.4342, 0.424, 0.423], 3),
]
...
# ── Layout ─────────────────────────────────────────────────────────
col_w   = [3.2, 0.85, 0.85, 0.85, 0.80, 0.80, 0.88, 0.88]
row_h   = 0.42
hdr_h   = 0.50
fig_w   = sum(col_w) + 0.1
...
plt.savefig('/Users/federicomarchi/Desktop/Thesis/patch-ib-cxr/thesisPdf/images/results_table_postvit.png',
